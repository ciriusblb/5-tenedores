...
import * as Permissions from "expo-permissions"; //permisos de usuario
import * as ImagePicker from "expo-image-picker"; // elegir imagen
  ...
  const imageSelect = async () => {
    ...
    if (resultPermissionCamera === "denied") {
      ...
      if (result.cancelled) {
        ...
        setImagesSelected([...imagesSelected, result.uri]); // funcion para añador imagnes a un array [...]
      }
    }
  }
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: () =>
            setImagesSelected(
              arrayImages.filter(imageUrl => imageUrl !== image) // eliminar dato de array
            )
        }
      ],
      { cancelable: false }
