...
import ListRestaurants from "../../components/Restaurants/ListRestaurant";
...
export default function Restaurants(props) {
  ...
  const handleLoadMore = async () => {
    ...
    await restaurantsDb.get().then(response => {
      ...
      setRestaurants([...restaurants, ...resultRestaurants]); // añadir los siguientes restaurantes al arreglo setRestaurants
    });
  };
